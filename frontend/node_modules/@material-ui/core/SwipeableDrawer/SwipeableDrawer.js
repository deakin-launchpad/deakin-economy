...
function (_React$Component) {
  ...
  function SwipeableDrawer() {
    ...
    _this.handleBodyTouchStart = function (event) {
      ...
      var anchor = (0, _Drawer.getAnchor)(_this.props.theme, _this.props.anchor);
      ...
      if (!open) {
        ...
        if ((0, _Drawer.isHorizontal)(_this.props.anchor)) {
    ...
    _this.handleBodyTouchMove = function (event) {
      ...
      var anchor = (0, _Drawer.getAnchor)(_this.props.theme, _this.props.anchor);
      var horizontalSwipe = (0, _Drawer.isHorizontal)(_this.props.anchor);
      var currentX = anchor === 'right' ? document.body.offsetWidth - event.touches[0].pageX : event.touches[0].pageX;
  ...
  (0, _createClass2.default)(SwipeableDrawer, [{
    ...
    value: function getMaxTranslate() {
      return (0, _Drawer.isHorizontal)(this.props.anchor) ? this.paperRef.clientWidth : this.paperRef.clientHeight;
    }
  }, {
    key: "getTranslate",
    value: function getTranslate(current) {
      var start = (0, _Drawer.isHorizontal)(this.props.anchor) ? this.startX : this.startY;
    ...
    value: function setPosition(translate) {
      ...
      var anchor = (0, _Drawer.getAnchor)(this.props.theme, this.props.anchor);
      var rtlTranslateMultiplier = ['right', 'bottom'].indexOf(anchor) !== -1 ? 1 : -1;
      var transform = (0, _Drawer.isHorizontal)(this.props.anchor) ? "translate(".concat(rtlTranslateMultiplier * translate, "px, 0)") : "translate(0, ".concat(rtlTranslateMultiplier * translate, "px)");
