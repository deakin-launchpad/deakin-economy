...
var TimePickerToolbar = function (_a) {
    var _b, _c;
    var date = _a.date, views = _a.views, ampm = _a.ampm, openView = _a.openView, onChange = _a.onChange, setOpenView = _a.setOpenView;
    var utils = useUtils_1.useUtils();
    var theme = styles_1.useTheme();
    var classes = exports.useStyles();
    var _d = useMeridiemMode(date, ampm, onChange), meridiemMode = _d.meridiemMode, handleMeridiemChange = _d.handleMeridiemChange;
    var hourMinuteClassName = theme.direction === 'rtl' ? classes.hourMinuteLabelReverse : classes.hourMinuteLabel;
    return (React.createElement(PickerToolbar_1.default, { className: clsx_1.default(classes.toolbar, (_b = {},
            _b[classes.toolbarLeftPadding] = ampm,
            _b)) },
        React.createElement("div", { className: hourMinuteClassName },
            views.includes('hours') && (React.createElement(React.Fragment, null,
            ...
            views.includes('minutes') && (React.createElement(ToolbarButton_1.default, { variant: "h2", onClick: function () { return setOpenView(ClockType_1.default.MINUTES); }, selected: openView === ClockType_1.default.MINUTES, label: utils.getMinuteText(date) })),
            views.includes('seconds') && (React.createElement(React.Fragment, null,
                React.createElement(ToolbarText_1.default, { variant: "h2", label: ":", selected: false, className: classes.separator }),
        ...
        ampm && (React.createElement("div", { className: clsx_1.default(classes.ampmSelection, (_c = {},
                _c[classes.ampmSelectionWithSeconds] = views.includes('seconds'),
                _c)) },
