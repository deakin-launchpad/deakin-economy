...
var defaultProps = __assign({}, prop_types_1.dateTimePickerDefaultProps, { wider: true, openTo: 'date', views: ['year', 'date', 'hours', 'minutes'] });
...
exports.DateTimePicker = WrappedPurePicker_1.makePurePicker({
    ...
    ToolbarComponent: DateTimePickerToolbar_1.DateTimePickerToolbar,
});
