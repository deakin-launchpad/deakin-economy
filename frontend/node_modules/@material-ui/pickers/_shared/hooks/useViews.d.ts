...
export declare function useViews(views: PickerView[], openTo: PickerView, onChange: (date: MaterialUiPickersDate, isFinish?: boolean) => void): {
    handleChangeAndOpenNext: (nextView: "date" | "year" | "month" | "hours" | "minutes" | "seconds" | null) => (date: import("../../typings/date").MaterialUiPickersDate, isFinish?: boolean | undefined) => void;
